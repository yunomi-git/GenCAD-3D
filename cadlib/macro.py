...
AVAILABLE_SEQUENCE_LENGTHS = list(range(3, 60))
NUM_SEQUENCE_LENGTHS = len(AVAILABLE_SEQUENCE_LENGTHS)
...
COMMAND_COLORS = {
    ...
    LINE_IDX: 'yellow',
    ARC_IDX: 'lime',
    CIRCLE_IDX: 'deepskyblue',

    SOL_IDX: 'gray',
    EOS_IDX: 'black',

}
COMMAND_CMAP = ListedColormap([COMMAND_COLORS[idx] for idx in range(len(ALL_COMMANDS))])