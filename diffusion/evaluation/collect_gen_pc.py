...
parser.add_argument('--src', type=str, default=None, required=False)
parser.add_argument('--n_points', type=int, default=2000)
args = parser.parse_args()

SAVE_DIR = paths.HOME_PATH + args.src + '_pc'
...
all_paths = glob.glob(paths.HOME_PATH + os.path.join(args.src, "*.h5"))
print("Loading from", os.path.join(args.src, "*.h5"))
print("Found paths", len(all_paths))
